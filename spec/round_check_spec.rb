...
describe GameOver do
  ...
  context 'checks for a connection of 4 from POV of newest token' do
    it 'returns false with no match of four' do
      ...
      expect(GameOver.game_over?(game.board, 5, 0)).to be false
    end
    ...
    it 'returns true with a green horizontal match' do
      ...
      expect(GameOver.game_over?(game.board, 0, 2)).to be true
    end
    ...
    it 'returns true with a green vertical match' do
      ...
      game.place_token("green", 2)
      game.place_token("green", 2)
      expect(GameOver.game_over?(game.board, 3, 2)).to be true
    end
    ...
    it 'returns true with an orange vertical match' do 
      ...
      game.place_token("orange", 4)
      game.place_token("orange", 4)
      expect(GameOver.game_over?(game.board, 3, 4)).to be true
    end

    it 'returns true with an orange downwards diagonal match' do 
      game.board[4][3] = "| \u{1F7E0} |"
      game.board[3][4] = "| \u{1F7E0} |"
      game.board[2][5] = "| \u{1F7E0} |"
      game.board[1][6] = "| \u{1F7E0} |"
    ...
    it 'returns true with a green downwards diagonal match' do 
      game.board[2][6] = "| \u{1F7E2} |"
      game.board[3][5] = "| \u{1F7E2} |"
      game.board[4][4] = "| \u{1F7E2} |"
      game.board[5][3] = "| \u{1F7E2} |"
      Display.board_display(game.board)
      expect(GameOver.game_over?(game.board, 5, 3)).to be true
    end
    ...
    it 'returns false with no diagonal match' do 
      ...
      # Display.board_display(game.board)
      expect(GameOver.game_over?(game.board, 2, 4)).to be false
    end
    ...
    it 'returns true with diagonal upward match to the right' do
      ...
      game.place_token("green", 1)
      # Display.board_display(game.board)
      expect(GameOver.game_over?(game.board, 5, 1)).to be true
    end
    it 'returns true with diagonal upward match to the left' do
      game.board[1][0] = "| \u{1F7E2} |"
      game.board[2][1] = "| \u{1F7E2} |"
      game.board[3][2] = "| \u{1F7E2} |"
      game.board[4][3] = "| \u{1F7E2} |"
      # Display.board_display(game.board)
      expect(GameOver.game_over?(game.board, 3, 2)).to be true
    end

    it 'returns true with diagonal upwards match from column 3 to the right' do
      game.board[2][5] = "| \u{1F7E0} |"
      game.board[4][3] = "| \u{1F7E0} |"
